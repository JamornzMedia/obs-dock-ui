...
export const translations = {
    ...
    en: {
        ...
        helpWebSocket: "<strong>Prerequisite:</strong> Enable <strong>OBS WebSocket</strong> in OBS Studio (Tools > WebSocket Server Settings). <br>Set Port: <code>4455</code> | Password: (Empty/None).",
    ...
    th: {
        ...
        helpWebSocket: "<strong>การเตรียมความพร้อม:</strong> เปิดใช้งาน <strong>OBS WebSocket</strong> ในโปรแกรม OBS (Tools > WebSocket Server Settings) <br>ตั้งค่า Port: <code>4455</code> | Password: (ว่างไว้/ไม่ต้องใส่).",
