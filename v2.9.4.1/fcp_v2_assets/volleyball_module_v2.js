...
function injectSettingsTab() {
  ...
  panel.innerHTML = `
    ...
    <div style="margin-bottom:14px;background:rgba(0,0,0,0.2);padding:10px 14px;border-radius:8px;border:1px solid rgba(255,255,255,0.06);">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
        <div>
          <div style="font-size:.75rem;color:#cbd5e1;margin-bottom:4px;">Font Name (Local)</div>
          <input type="text" id="vb2-font-name" value="${getVbState(VB_FONT_KEY, 'Barlow Condensed')}" placeholder="Arial" style="width:100%;padding:6px;background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.12);border-radius:6px;color:#fff;font-size:12px;">
        </div>
        <div>
