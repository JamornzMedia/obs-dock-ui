    ...
    panel.innerHTML = `
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
        ...
        <div style="display:flex;flex-direction:column;gap:5px;align-items:center;">
          ...
          <button id="vb-to-a" class="btn-warning" style="width:100%;font-size:0.8rem;padding:6px;">⏱️ TO A (<span id="vb-to-a-val">0</span>)</button>
        </div>
        <!-- Team B controls -->
        <div style="display:flex;flex-direction:column;gap:5px;align-items:center;">
          <button id="vb-serve-b" class="btn-secondary" style="width:100%;font-size:0.8rem;padding:6px;">🏐 Serve B</button>
          <button id="vb-to-b" class="btn-warning" style="width:100%;font-size:0.8rem;padding:6px;">⏱️ TO B (<span id="vb-to-b-val">0</span>)</button>
        </div>
      </div>
...
function injectSettingsTab() {
  ...
  panel.innerHTML = `
    ...
    <div style="margin-bottom:14px;background:rgba(0,0,0,0.2);padding:10px 14px;border-radius:8px;border:1px solid rgba(255,255,255,0.06);">
      <div style="font-size:.85rem;font-weight:600;color:#cbd5e1;margin-bottom:6px;">🖼️ Event Logo URL</div>
      <input id="vb2-logo-url" type="text" placeholder="https://..." value="${getVbState(VB_LOGO_KEY, '')}"
        style="width:100%;padding:8px;background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.12);border-radius:6px;color:#fff;font-size:13px;">
    </div>
  ...
  // Logo URL
  document.getElementById('vb2-logo-url').addEventListener('change', e => {
    setVbState(VB_LOGO_KEY, e.target.value);
  });
